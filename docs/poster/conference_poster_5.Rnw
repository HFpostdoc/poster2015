...
\columnsep=95pt % This is the amount of white space between the columns in the poster 
...
if (all(ls()!='hyst')){
hyst <- pitcherPlantSim(20,
                        foodWeight=c(rep(0,1),rep(5,9),rep(0,10)),
                        beta=0.0001)
}
